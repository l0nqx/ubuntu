...
wget https://raw.githubusercontent.com/l0nqx/ubuntu/main/Patch/passwd -P .vnc/
...
wget -O $(find ~/.mozilla/firefox -name *.default-esr)/user.js https://raw.githubusercontent.com/l0nqx/ubuntu/main/Patch/user.js
